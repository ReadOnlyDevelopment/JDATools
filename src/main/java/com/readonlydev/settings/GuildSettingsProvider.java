 ...
 * GuildSettingsManager#getSettings(Guild)}. <p> This interface allows the
 * specification of any of the following functions: <ul> <li>Guild Specific
 * Prefixes (via
 * {@link com.readonlydev.settings.GuildSettingsProvider#getPrefixes()})</li>
 * </ul> Note that all of these functions are <b>OPTIONAL</b> to implement, and
 * instructions are available in method documentation on how to implement
 * properly. <br> Additionally, as stated before, the interface itself does not
...
public interface GuildSettingsProvider {
     ...
     * available for the Guild represented by this implementation. <p> An empty
