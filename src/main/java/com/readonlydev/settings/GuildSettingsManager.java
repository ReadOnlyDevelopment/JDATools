 ...
 *           implement additional methods. <br> If in the future it is decided
...
public interface GuildSettingsManager<T> {
     ...
     * Guild} as an object of the specified type {@code T}, or {@code null} if
     * the guild has no settings.
     *
     * @param guild
     *        The guild to get settings for.
     *
     * @return The settings object for the guild, or {@code null} if the guild
     *         has no settings.
     */
    @Nullable
     ...
     * {@link net.dv8tion.jda.api.events.ShutdownEvent ShutdownEvent}. <p>
     * Developers should implement this method to free up or close resources
     * when shutting their bot.
     */
