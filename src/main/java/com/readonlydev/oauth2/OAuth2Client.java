...
package com.readonlydev.oauth2;
...
import com.readonlydev.oauth2.entities.impl.OAuth2ClientImpl;
 ...
 * Discord API. <p> OAuth2Client's are made using a
...
public interface OAuth2Client {
    ...
    /**
     * Starts a {@link com.readonlydev.oauth2.session.Session Session} with the
     * provided code, state, and identifier. The state provided should be
     * <i>unique</i> and provided through an implementation of
     * {@link com.readonlydev.oauth2.state.StateController StateController}. <p>
     * If the state has already been consumed by the StateController using
     * {@link com.readonlydev.oauth2.state.StateController#consumeState(String)
     ...
     */
    @CheckReturnValue
    OAuth2Action<Session> startSession(String code, String state,
     ...
     * from the {@link com.readonlydev.oauth2.session.Session Session}. <p> All
    ...
    /**
     * Requests a list of {@link com.readonlydev.oauth2.entities.OAuth2Guild
     * OAuth2Guilds} from the {@link com.readonlydev.oauth2.session.Session
     * Session}. <p> All Sessions should handle an individual Discord User, and
     * as such this method retrieves data on all the various Discord Guilds that
     * user is a part of when the session is provided. <p> Note that this can
     * only be performed for Sessions who have the necessary
     * {@link com.readonlydev.oauth2.Scope#GUILDS 'guilds'} scope. <br> Trying
    ...
    /**
     * Gets the client's {@link com.readonlydev.oauth2.state.StateController
     * StateController}.
     *
    ...
    /**
     * Gets the client's {@link com.readonlydev.oauth2.session.SessionController
     * SessionController}.
     *
    ...
    /**
     * Builder for creating OAuth2Client instances. <p> At minimum, the
    ...
    class Builder {
        ...
        /**
         * Finalizes and builds an {@link com.readonlydev.oauth2.OAuth2Client
         * OAuth2Client} instance using this builder.
         *
         * @return The OAuth2Client instance build.
         *
         * @throws java.lang.IllegalArgumentException
         *         If either: <ul> <li>The Client ID is not valid.</li> <li>The
         *         Client Secret is empty.</li> </ul>
         */
        public OAuth2Client build() {
            Checks.check(clientId >= 0, "Client ID is invalid!");
            Checks.notEmpty(clientSecret, "Client Secret");
            return new OAuth2ClientImpl(clientId, clientSecret,
                sessionController, stateController, client);
        }
