...
public class ButtonMenu extends Menu {
    ...
    ButtonMenu(EventWaiter waiter, Set<User> users, Set<Role> roles,
            long timeout, TimeUnit unit, Color color, String text,
            String description, List<String> choices,
            Consumer<ReactionEmote> action, Consumer<Message> finalAction) {
    ...
    /**
     * Shows the ButtonMenu as a new {@link net.dv8tion.jda.api.entities.Message
                    ...
                    r.queue(v -> {
                        waiter
                            .waitForEvent(MessageReactionAddEvent.class,
                                event -> {
                                    // If the message is not the same as the
                                    // ButtonMenu
                                    // currently being displayed.
                                    if (!event.getMessageId().equals(m.getId()))
                                        return false;

                                    // If the reaction is an Emote we get the
                                    // Snowflake,
                                    ...
                                    // If the value we got is not registered as
                                    // a button to
                                    // the ButtonMenu being displayed we return
                                    // false.
                                    if (!choices.contains(re))
                                        return false;

                                    // Last check is that the person who added
                                    // the reaction
                                    // is a valid user.
                                    return isValidUser(event.getUser(),
                                        event.isFromGuild() ? event.getGuild()
                                                : null);
     ...
     * {@link com.readonlydev.menu.ButtonMenu ButtonMenu}.
     */
    public static class Builder extends Menu.Builder<Builder, ButtonMenu> {
        ...
        /**
         * Builds the {@link com.readonlydev.menu.ButtonMenu ButtonMenu} with
         * this Builder.
         *
        ...
        public ButtonMenu build() {
            ...
            return new ButtonMenu(waiter, users, roles, timeout, unit, color,
                text, description, choices, action, finalAction);
        }
         ...
         * {@link com.readonlydev.menu.ButtonMenu ButtonMenu} is built. <p> This
         ...
         * the {@link com.readonlydev.menu.ButtonMenu ButtonMenu} is done,
        ...
        /**
         * Adds a single String unicode emoji as a button choice. <p> Any
         * non-unicode {@link net.dv8tion.jda.api.entities.Emote Emote} should
         * be added using {@link ButtonMenu.Builder#addChoice(Emote)
        ...
        /**
         * Adds a single custom {@link net.dv8tion.jda.api.entities.Emote Emote}
         * as button choices. <p> Any regular unicode emojis should be added
         * using {@link ButtonMenu.Builder#addChoice(String)
        ...
        /**
         * Adds String unicode emojis as button choices. <p> Any non-unicode
         * {@link net.dv8tion.jda.api.entities.Emote Emote}s should be added
         * using {@link ButtonMenu.Builder#addChoices(Emote...)
        ...
        /**
         * Adds custom {@link net.dv8tion.jda.api.entities.Emote Emote}s as
         * button choices. <p> Any regular unicode emojis should be added using
        ...
        /**
         * Sets the String unicode emojis as button choices. <p> Any non-unicode
         * {@link net.dv8tion.jda.api.entities.Emote Emote}s should be set using
         * {@link ButtonMenu.Builder#setChoices(Emote...)
        ...
        /**
         * Sets the {@link net.dv8tion.jda.api.entities.Emote Emote}s as button
         * choices. <p> Any regular unicode emojis should be set using
