...
/**
 * A {@link com.readonlydev.menu.Menu Menu} implementation that creates a organized display of emotes/emojis as buttons
...
public class ButtonMenu extends Menu
{
	...
	/**
	 * The {@link com.readonlydev.menu.Menu.Builder Menu.Builder} for a {@link com.readonlydev.menu.ButtonMenu
	 * ButtonMenu}.
	 *
	 * @author John Grosh
	 */
	public static class Builder extends Menu.Builder<Builder, ButtonMenu>
	{
		...
		/**
		 * Builds the {@link com.readonlydev.menu.ButtonMenu ButtonMenu} with this Builder.
		 *
		 ...
		 * {@link com.readonlydev.menu.ButtonMenu ButtonMenu} is done, either via cancellation, a timeout, or a
