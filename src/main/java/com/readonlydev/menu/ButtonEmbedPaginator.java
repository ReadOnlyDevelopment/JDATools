...
public class ButtonEmbedPaginator extends Menu {
    ...
    public static final Emoji                          BIG_LEFT   = Emoji
            .fromUnicode("\u23EA");

    public static final Emoji                          LEFT       = Emoji
            .fromUnicode("\u25C0");

    public static final Emoji                          STOP       = Emoji
            .fromUnicode("\u23F9");

    public static final Emoji                          RIGHT      = Emoji
            .fromUnicode("\u25B6");

    public static final Emoji                          BIG_RIGHT  = Emoji
            .fromUnicode("\u23E9");

    protected ButtonEmbedPaginator(EventWaiter waiter, Set<User> users,
    ...
    private void initialize(RestAction<Message> action, int pageNum) {
        action.queue(m -> {
            if (embeds.size() > 1) {
                ...
                m
                .editMessage(renderPage(pageNum))
                ...
                m
                .editMessage(renderPage(pageNum))
                .setActionRow(Button.of(style, id, STOP))
                .queue(v -> pagination(m, pageNum));
            } else {
    ...
    private boolean checkButton(ButtonInteractionEvent event, long messageId) {
        if (event.getComponentId().startsWith("bep:")
                && !paginators.contains(event.getMessageId())) {
            event
            .reply(
                "This paginator is no longer active. The buttons will be removed. Please make a new one!")
            .setEphemeral(true)
            .queue();
        ...
        if (Arrays
                .asList(STOP, LEFT, RIGHT)
                .contains(event.getButton().getEmoji())) {
            return isValidUser(event.getUser(),
                event.isFromGuild() ? event.getGuild() : null);
        } else if (Arrays
                .asList(BIG_LEFT, BIG_RIGHT)
                .contains(event.getButton().getEmoji())) {
    ...
    private void handleButtonInteraction(ButtonInteractionEvent event,
        ...
        if (emoji == null) {
            ...
            .warn("Received null emoji in ButtonInteractionEvent!");
            return;
        }
    ...
    extends Menu.Builder<Builder, ButtonEmbedPaginator> {
        ...
        private BiFunction<Integer, Integer, String> text             = (page,
                 ...
                 *         {@link EventWaiter} was set.</li> <li>No items were set to
                 *         paginate.</li> </ul>
                 */
                @Override
                public ButtonEmbedPaginator build() {
                    ...
                    return new ButtonEmbedPaginator(waiter, users, roles, timeout, unit,
                        text, finalAction, waitOnSinglePage, embeds, bulkSkipNumber,
                        wrapPageEnds, style);
                }

                /**
                 * Sets the text of the {@link Message} to be displayed when the
                 * {@link ButtonEmbedPaginator} is built.
                 *
                 * @param text
                ...
                /**
                 * Sets the text of the {@link Message} to be displayed relative to the
                 * total page number and the current page as determined by the provided
                 * {@link BiFunction}. <br> As the page changes, the BiFunction will
                 * re-process the current page number and the total page number,
                 * allowing for the displayed text of the Message to change depending on
                 * the page number.
                 *
                 ...
                 * {@link ButtonEmbedPaginator} times out.
                 *
                 * @param finalAction
                ...
                /**
                 * Sets whether the {@link ButtonEmbedPaginator} will instantly timeout,
                 * and possibly run a provided {@link Runnable}, if only a single slide
                ...
                /**
                 * Adds the collection of provided {@link MessageEmbed} to the list of
                 * items to paginate.
                 *
                 * @param embeds
                ...
                /**
                 * Adds {@link MessageEmbed MessageEmbeds} to the list of items to
                 * paginate. <br> This method creates a new, basic MessageEmbed
                 * containing only the provided String as description. <br> Use the
                 * {@link Paginator} for more Embed customization, without providing
                 * your own MessageEmbed instances.
                 *
                 * @param items
                ...
                /**
                 * Sets the {@link MessageEmbed} to paginate. <br> This method clears
                ...
                /**
                 * Sets the {@link MessageEmbed MessageEmbeds} to paginate. <br> This
                 * method clears all previously set items before adding the provided
                 * collection of MessageEmbeds.
                 *
                 * @param embeds
                ...
                /**
                 * Sets the {@link MessageEmbed MessageEmbeds} to paginate. <br> This
                 * method clears all previously set items before setting each String as
                 * a new MessageEmbed. <br> Use the {@link Paginator} for more Embed
                ...
                /**
                 * Sets the {@link ButtonEmbedPaginator}'s bulk-skip function to skip
                 * multiple pages using alternate forward and backwards reactions.
                 *
                ...
                /**
                 * Sets the {@link ButtonStyle} to use for the buttons. By default, this
                 * is {@link ButtonStyle#SECONDARY SECONARY}.
                 *
                 * @param style
                 *        The new style
                 *
