...
public class SelectionDialog extends Menu {
    ...
    SelectionDialog(EventWaiter waiter, Set<User> users, Set<Role> roles,
            long timeout, TimeUnit unit, List<String> choices, String leftEnd,
            String rightEnd, String defaultLeft, String defaultRight,
            Function<Integer, Color> color, boolean loop,
            BiConsumer<Message, Integer> success, Consumer<Message> cancel,
            Function<Integer, String> text, boolean singleSelectionMode) {
    ...
    /**
     * Constructor for backwards compatibility (calls new constructor with
     * singleSelectionMode = false)
     * 
     * @deprecated Use Constructor with extra boolean
     *             {@code singleSelectionMode} instead
     */
    @Deprecated
    SelectionDialog(EventWaiter waiter, Set<User> users, Set<Role> roles,
            long timeout, TimeUnit unit, List<String> choices, String leftEnd,
        ...
        this(waiter, users, roles, timeout, unit, choices, leftEnd, rightEnd,
     ...
     * {@link net.dv8tion.jda.api.entities.Message Message} in the provided
     * {@link net.dv8tion.jda.api.entities.MessageChannel MessageChannel},
     * starting with the number selection provided.
     * 
     * @param channel
     *        The MessageChannel to send the new Message to
     * @param selection
    ...
    private void initialize(RestAction<Message> action, int selection) {
        action.queue(m -> {
            if (choices.size() > 1) {
                ...
                m
                    .addReaction(DOWN)
                    .queue(v -> selectionDialog(m, selection),
                        v -> selectionDialog(m, selection));
            } else {
                m.addReaction(SELECT).queue();
                m
                    .addReaction(CANCEL)
     ...
     * {@link com.readonlydev.menu.SelectionDialog SelectuibDialog}.
     */
    public static class Builder extends Menu.Builder<Builder, SelectionDialog> {
        ...
        /**
         * Builds the {@link com.readonlydev.menu.SelectionDialog
         * SelectionDialog} with this Builder.
         *
         ...
         *         was set.</li> <li>No choices were set.</li> <li>No action
         *         {@link java.util.function.Consumer Consumer} was set.</li>
         *         </ul>
         */
        @Override
        public SelectionDialog build() {
            ...
            Checks
                .check(selection != null, "Must provide a selection consumer");

            return new SelectionDialog(waiter, users, roles, timeout, unit,
                choices, leftEnd, rightEnd, defaultLeft, defaultRight, color,
                loop, selection, cancel, text, singleSelectionMode);
        }
         ...
         * Sets the {@link java.awt.Color Color} of the
         * {@link net.dv8tion.jda.api.entities.MessageEmbed MessageEmbed},
         * relative to the current selection number as determined by the
         * provided {@link java.util.function.Function Function}. <br> As the
         * selection changes, the Function will re-process the current selection
         * number, allowing for the color of the embed to change depending on
         * the selection number.
         *
         * @param color
         *        A Function that uses current selection number to get a Color
         *        for the MessageEmbed
         *
         * @return This builder
         */
         ...
         * {@link com.readonlydev.menu.SelectionDialog SelectionDialog} is
         * built. <p> This is displayed directly above the embed.
         *
         * @param text
        ...
        /**
         * Sets the text of the {@link net.dv8tion.jda.api.entities.Message
         * Message} to be displayed relative to the current selection number as
         * determined by the provided {@link java.util.function.Function
         * Function}. <br> As the selection changes, the Function will
         * re-process the current selection number, allowing for the displayed
         * text of the Message to change depending on the selection number.
         *
         * @param text
         *        A Function that uses current selection number to get a text
         *        for the Message
         *
         * @return This builder
         */
        ...
        /**
         * Sets the text to use on either end of the selected item. <br> Usage
         * is primarily to mark which item is currently selected.
         *
         * @param left
        ...
        /**
         * Sets the text to use on either side of all unselected items. This
         * will not be applied to the selected item. <br> Usage is primarily to
         * mark which items are not currently selected.
         *
         * @param left
        ...
        /**
         * Sets if moving up when at the top selection jumps to the bottom, and
         * visa-versa.
         *
         * @param loop
         *        {@code true} if pressing up while at the top selection should
        ...
        /**
         * Sets if the Menu should exit when a selection was made. By default,
         * this is false and the menu continues showing choices even after a
         * selection was made.
         *
         * @param singleSelectionMode
         *        {@code true} if the menu should exit after the first selection
         *        being made
         *
         * @return This builder
         */
        ...
        /**
         * Sets a {@link java.util.function.BiConsumer BiConsumer} action to
         * perform once a selection is made. <br> The
         * {@link net.dv8tion.jda.api.entities.Message Message} provided is the
         * one used to display the menu and the {@link java.lang.Integer
         * Integer} is that of the selection made by the user, and selections
         * are in order of addition, 1 being the first String choice.
         *
         * @param selection
         ...
         */
        public Builder
                setSelectionConsumer(BiConsumer<Message, Integer> selection) {
            this.selection = selection;
            return this;
        }

        /**
         * Sets a {@link java.util.function.Consumer Consumer} action to take if
         * the menu is cancelled, either via the cancel button being used, or if
