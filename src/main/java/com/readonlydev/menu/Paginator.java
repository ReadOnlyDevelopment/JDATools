...
public class Paginator extends Menu {
	...
	public static class Builder extends Menu.Builder<Builder, Paginator> {
		 ...
		 * be displayed when the {@link com.readonlydev.menu.Paginator Paginator} is
		 * built.
		 * <p>
		...
		/**
		 * Sets whether the {@link com.readonlydev.menu.Paginator Paginator} will
		...
		/**
		 * Sets the {@link com.readonlydev.menu.Paginator Paginator} to allow a page
