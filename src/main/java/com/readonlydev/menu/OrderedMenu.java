/*
 * Copyright 2016-2018 John Grosh (jagrosh) & Kaidan Gustave (TheMonitorLizard) Licensed under the Apache License,
...
/**
 * A {@link com.readonlydev.menu.Menu Menu} of ordered buttons signified by numbers or letters, each with a reaction
...
public class OrderedMenu extends Menu
{
	...
	/**
	 * The {@link com.readonlydev.menu.Menu.Builder Menu.Builder} for an {@link com.readonlydev.menu.OrderedMenu
	 * OrderedMenu}.
	 *
	 * @author John Grosh
	 */
	public static class Builder extends Menu.Builder<Builder, OrderedMenu>
	{
		...
		/**
		 * Builds the {@link com.readonlydev.menu.OrderedMenu OrderedMenu} with this Builder.
		 *
		 ...
		 *             <ul>
		 *             <li>No {@link com.readonlydev.common.waiter.EventWaiter EventWaiter} was set.</li>
		...
		/**
		 * Sets the builder to build an {@link com.readonlydev.menu.OrderedMenu OrderedMenu} using letters for ordering
		...
		/**
		 * Sets the builder to build an {@link com.readonlydev.menu.OrderedMenu OrderedMenu} using numbers for ordering
		...
		/**
		 * Sets the text of the {@link Message Message} to be displayed when the {@link com.readonlydev.menu.OrderedMenu
		 ...
		 * {@link com.readonlydev.menu.OrderedMenu OrderedMenu} is cancelled.
		 *
		 * @param cancel
