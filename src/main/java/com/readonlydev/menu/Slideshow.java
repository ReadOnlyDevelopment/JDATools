...
public class Slideshow extends Menu
{
	 ...
	 * a {@link com.readonlydev.menu.Slideshow Slideshow}.
	 *
	 * @author John Grosh
	 */
	public static class Builder extends Menu.Builder<Builder, Slideshow>
	{
		...
		/**
		 * Builds the {@link com.readonlydev.menu.Slideshow Slideshow}
		 * with this Builder.
		 *
		 ...
		 * displayed when the
		 * {@link com.readonlydev.menu.Slideshow Slideshow} is built.
		 *
		 * @param description
		 ...
		 * the
		 * {@link com.readonlydev.menu.Slideshow Slideshow} times out.
		 *
		 * @param finalAction
		...
		/**
		 * Sets the {@link com.readonlydev.menu.Slideshow Slideshow} to allow
