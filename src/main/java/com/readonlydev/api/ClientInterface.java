 ...
 * <ul>
 * <li>{@link com.readonlydev.command.Command Command}s may be added or removed.</li>
 * <li>The {@link com.readonlydev.command.CommandListener CommandListener} may be set.</li>
 * </ul>
 *
...
public interface ClientInterface
{
	 ...
	 * <p>
	 * This is the same as {@link com.readonlydev.api.ClientInterface#getPrefix() } unless the prefix is the default, in
	...
	/**
	 * Adds a single {@link com.readonlydev.command.Command Command} to this Client's registered Commands.
	 * <p>
	 ...
	 * {@link com.readonlydev.command.Command#name name} and their {@link com.readonlydev.command.Command#aliases
	...
	/**
	 * Adds a single {@link com.readonlydev.command.Command Command} to this Client's registered Commands at the
	 * specified index.
	 * <p>
	 * For Client's containing 20 commands or less, command calls by users will have the bot iterate through the entire
	 * {@link java.util.ArrayList ArrayList} to find the command called. As expected, this can get fairly hefty if a bot
	 ...
	 * <br>
	 * Indexed calls use a {@link java.util.HashMap HashMap} which links their
	 * {@link com.readonlydev.command.Command#name name} to the index that which they are located at in the ArrayList
	 * they are stored.
	 * <p>
	 * This means that all insertion and removal of Commands must reorganize the index maintained by the HashMap. <br>
	 * For this particular insertion, the Command provided is inserted at the index specified, meaning it will become
	...
	/**
	 * Removes a single {@link com.readonlydev.command.Command Command} from this Client's registered Commands at the
	...
	/**
	 * Sets the {@link com.readonlydev.command.CommandListener CommandListener} to catch command-related events thrown
	 * by this {@link com.readonlydev.api.ClientInterface Client}.
	 *
	 * @param listener
	 *            The CommandListener
	 */
	...
	/**
	 * Returns the current {@link com.readonlydev.command.CommandListener CommandListener}.
	 *
	...
	/**
	 * Returns the list of registered {@link com.readonlydev.command.Command Command}s during this session.
	 *
	...
	/**
	 * Gets the time this {@link com.readonlydev.api.ClientInterface Client} implementation was created.
	 *
	...
	/**
	 * Gets the number of uses for the provide {@link com.readonlydev.command.Command Command} during this session, or
	...
	/**
	 * Gets the number of uses for a {@link com.readonlydev.command.Command Command} during this session matching the
	 ...
	 * {@link com.readonlydev.command.Command#aliases alias} is provided! Also note that
	 * {@link com.readonlydev.command.Command#children child commands} <b>ARE NOT</b> tracked and providing names or
	 ...
	 * <p>
	 * This is used for methods such as {@link com.readonlydev.command.event.CommandEvent#async(Runnable)
	...
	/**
	 * Returns the type of {@link com.readonlydev.settings.GuildSettingsManager GuildSettingsManager}, the same type of
