 ...
 * properties that make it unique and complex while maintaining a low level of development. <br> All Commands extending this class can define any number of these fields in a object constructor and then create the command action/response in the abstract
 * {@link com.readonlydev.command.Command#execute(com.readonlydev.command.CommandEvent) #execute(CommandEvent)} body:
 *
 * <pre>
 ...
 * </pre>
 *
 * Execution is with the provision of a MessageReceivedEvent-Client wrapper called a {@link com.readonlydev.command.event.CommandEvent CommandEvent} and is performed in two steps: <ul> <li>{@link com.readonlydev.command.Command#run(CommandEvent) run} - The command runs through a series of
 * conditionals, automatically terminating the command instance if one is not met, and possibly providing an error response.</li> <li>{@link com.readonlydev.command.Command#execute(CommandEvent) execute} - The command, now being cleared to run, executes and performs whatever lies in the abstract
 * body method.</li> </ul>
 */
public abstract class Command extends UserInteraction
{
    ...
    /**
     * The name of the command, allows the command to be called the formats: <br> Normal Command: {@code [prefix]<command name>}. <br> Slash Command: {@code /<command name>}
     */
    ...
    /**
     * The {@link com.readonlydev.command.Command.Category Category} of the command. <br> This can perform any other checks not completed by the default conditional fields.
     */
    ...
    /**
     * {@code true} if the command may only be used by a User with an ID matching the Owners or any of the CoOwners.<br> If enabled for a Slash Command, only owners (owner + up to 9 co-owners) will be added to the SlashCommand. All other permissions will be ignored. <br> Default {@code false}.
     */
    ...
    /**
     * Any {@link net.dv8tion.jda.api.Permission Permission}s a Member must have to use this command. <br> These are only checked in a {@link net.dv8tion.jda.api.entities.Guild Guild} environment.
     */
    protected Permission[] userPermissions = new Permission[0];

    /**
     * Any {@link net.dv8tion.jda.api.Permission Permission}s the bot must have to use a command. <br> These are only checked in a {@link net.dv8tion.jda.api.entities.Guild Guild} environment.
     */
    protected Permission[] botPermissions = new Permission[0];

    /**
     * The aliases of the command, when calling a command these function identically to calling the {@link com.readonlydev.command.Command#name Command.name}. This options only works for normal commands, not slash commands.
     */
    ...
    /**
     * The {@link java.util.function.BiConsumer BiConsumer} for creating a help response to the format {@code [prefix]<command name> help}.
     */
    protected BiConsumer<CommandEvent, Command> helpBiConsumer = null;

    /**
     * {@code true} if this command checks a channel topic for topic-tags. <br> This means that putting {@code {-commandname}}, {@code {-command category}}, {@code {-all}} in a channel topic will cause this command to terminate. <br> Default {@code true}.
     */
    protected boolean usesTopicTags = true;

    /**
     * {@code true} if this command should be hidden from the help. <br> Default {@code false}<br> <b>This has no effect for SlashCommands.</b>
     */
    protected boolean hidden = false;

    /**
     * The {@link com.readonlydev.api.CooldownScope CooldownScope} of the command. This defines how far of a scope cooldowns have. <br> Default {@link com.readonlydev.api.CooldownScope#USER CooldownScope.USER}.
     */
    ...
    /**
     * The main body method of a {@link com.readonlydev.command.Command Command}. <br> This is the "response" for a successful {@link com.readonlydev.command.Command#run(CommandEvent) #run(CommandEvent)}.
     *
     * @param event The {@link com.readonlydev.command.event.CommandEvent CommandEvent} that triggered this Command
     */
    protected abstract void execute(CommandEvent event);

    /**
     * Runs checks for the {@link com.readonlydev.command.Command Command} with the given {@link com.readonlydev.command.event.CommandEvent CommandEvent} that called it. <br> Will terminate, and possibly respond with a failure message, if any checks fail.
     *
     ...
     *
     * @param  messageChannelUnion The TextChannel to test.
     *
     * @return                     {@code true} if the channel topic doesn't specify any topic-tags that would cause this command to be cancelled, or if {@code usesTopicTags} has been set to {@code false}.
     */
    ...
    /**
     * Gets the {@link com.readonlydev.command.Command#name Command.name} for the Command.
     *
    ...
    /**
     * Gets the {@link com.readonlydev.command.Command#help Command.help} for the Command.
     *
    ...
    /**
     * Gets the {@link com.readonlydev.command.Command#category Command.category} for the Command.
     *
    ...
    /**
     * Gets the {@link com.readonlydev.command.Command#arguments Command.arguments} for the Command.
     *
     ...
     *
     * @return {@code true} if this Command can only be used in a Guild, else {@code false} if it can be used outside of one
     */
    ...
    /**
     * Gets the {@link com.readonlydev.command.Command#requiredRoles Command.requiredRoles} for the Command.
     *
    ...
    /**
     * Gets the {@link com.readonlydev.command.Command#cooldown Command.cooldown} for the Command.
     *
    ...
    /**
     * Gets the {@link com.readonlydev.command.Command#userPermissions Command.userPermissions} for the Command.
     *
    ...
    /**
     * Gets the {@link com.readonlydev.command.Command#botPermissions Command.botPermissions} for the Command.
     *
    ...
    /**
     * Gets the {@link com.readonlydev.command.Command#aliases Command.aliases} for the Command.
     *
    ...
    /**
     * Gets the {@link com.readonlydev.command.Command#children Command.children} for the Command.
     *
    ...
    /**
     * Gets the proper cooldown key for this Command under the provided {@link com.readonlydev.command.event.CommandEvent CommandEvent}.
     *
    ...
    /**
     * Gets an error message for this Command under the provided {@link com.readonlydev.command.event.CommandEvent CommanEvent}.
     *
    ...
    /**
     * To be used in {@link com.readonlydev.command.Command Command}s as a means of organizing commands into "Categories" as well as terminate command usage when the calling {@link com.readonlydev.command.event.CommandEvent CommandEvent} doesn't meet certain requirements.
     */
    public static class Category
    {
        ...
        /**
         * A Command Category containing a name and a {@link java.util.function.Predicate}. <p> The command will be terminated if {@link com.readonlydev.command.Command.Category#test(com.readonlydev.command.CommandEvent)} returns {@code false}.
         *
         * @param name      The name of the Category
        ...
        /**
         * A Command Category containing a name, a {@link java.util.function.Predicate}, and a failure response. <p> The command will be terminated if {@link com.readonlydev.command.Command.Category#test(com.readonlydev.command.CommandEvent)} returns {@code false}, and the failure response will be
         * sent.
         *
         * @param name         The name of the Category
         ...
         *
         * @param  event The {@link com.readonlydev.command.event.CommandEvent CommandEvent} that was called when this method is invoked
         *
         * @return       {@code true} if the Predicate was not set, was set as null, or was tested and returned true, otherwise returns {@code false}
         */
