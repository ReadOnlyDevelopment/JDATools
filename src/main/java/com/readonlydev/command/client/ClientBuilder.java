...
/**
 * A simple builder used to create a {@link com.readonlydev.command.client.Client ClientImpl}. <p> Once built, add the {@link com.readonlydev.api.ClientInterface Client} as an EventListener to {@link net.dv8tion.jda.api.JDA JDA} and it will automatically handle commands with ease!
 */
public class ClientBuilder
{
    ...
    /**
     * Builds a {@link com.readonlydev.command.client.Client ClientImpl} with the provided settings.
     * <br> Once built, only the {@link com.readonlydev.command.CommandListener CommandListener},
     * and {@link com.readonlydev.command.Command Command}s can be changed.
     *
    ...
    public Client build()
    {
        ...
        Client client = new Client(
            ownerId, coOwnerIds, prefix, prefixes, botTestingServerId, prefixFunction, commandPreProcessFunction,
            commandPreProcessBiFunction, activity, status, serverInvite, success, warning, error,
            new ArrayList<>(commands), new ArrayList<>(slashCommands), new ArrayList<>(contextMenus),
            serverCommands, globalCommands, embedAllReplies, useHelp, shutdownAutomatically, helpConsumer,
    ...
    /**
     * Sets the owner for the bot. <br> Make sure to verify that the ID provided is ISnowflake compatible when setting this. If it is not, this will warn the developer.
     *
    ...
    /**
     * Sets the one or more CoOwners of the bot. <br> Make sure to verify that all of the IDs provided are ISnowflake compatible when setting this. If it is not, this will warn the developer which ones are not.
     *
    ...
    /**
     * Sets the bot's prefix. <br> If set null, empty, or not set at all, the bot will use a mention {@literal @Botname} as a prefix.
     *
    ...
    /**
     * Sets the Prefix Function. Used if you want custom prefixes per server. <br> Be careful, this function should be quick, as it's executed every time MessageReceivedEvent is called. <br> If function returns null, it will be ignored.
     *
    ...
    /**
     * Sets the pre-process function. This code is executed before every command.<br> Returning "true" will allow processing to proceed.<br> Returning "false" or "null" will prevent the Command from executing.<br> You can use Command to see which command will run.<br> <b>This cannot be used in
     * conjunction with {@link #setCommandPreProcessFunction(Function)}.</b>
     *
    ...
    /**
     * Sets whether the {@link com.readonlydev.api.ClientInterface Client} will use the builder to automatically create a help command or not.
     *
     * @param  useHelp {@code false} to disable the help command builder, otherwise the Client will use either the default or one provided via {@link com.readonlydev.command.client.ClientBuilder#setHelpConsumer(Consumer)}}.
     *
     * @return         This builder
     */
    ...
    /**
     * Sets the consumer to run as the bot's help command. <br> Setting it to {@code null} or not setting this at all will cause the bot to use the default help builder.
     *
     * @param  helpConsumer A consumer to accept a {@link com.readonlydev.command.event.CommandEvent CommandEvent} when a help command is called.
     *
     * @return              This builder
     */
    ...
    /**
     * Sets the word used to trigger the command list. <br> Setting this to {@code null} or not setting this at all will set the help word to {@code "help"}.
     *
    ...
    /**
     * Sets the {@link net.dv8tion.jda.api.entities.Activity Game} to use when the bot is ready. <br> Can be set to {@code null} for JDA Utilities to not set it.
     *
    ...
    /**
     * Sets the {@link net.dv8tion.jda.api.entities.Activity Game} the bot will use as the default: 'Playing <b>Type [prefix]help</b>'
     *
     * @return This builder
     */
    ...
    /**
     * Sets the {@link net.dv8tion.jda.api.OnlineStatus OnlineStatus} the bot will use once Ready This defaults to ONLINE
     *
    ...
    /**
     * Adds a {@link com.readonlydev.command.Command Command} and registers it to the {@link com.readonlydev.command.client.Client ClientImpl} for this session.
     *
    ...
    /**
     * Adds and registers all {@link com.readonlydev.command.Command Command}s in the collection to the {@link com.readonlydev.command.client.Client ClientImpl} for this session. <br> This is the same as running a forEach loop on the Collection
    ...
    /**
     * Adds and registers multiple {@link com.readonlydev.command.Command Command}s to the {@link com.readonlydev.command.client.Client ClientImpl} for this session. <br> This is the same as calling {@link com.readonlydev.command.client.ClientBuilder#addCommand(Command)} multiple times.
     *
    ...
    /**
     * Adds and registers all {@link com.readonlydev.command.slash.SlashCommand SlashCommand}s in the collection to the {@link com.readonlydev.command.client.Client ClientImpl} for this session. <br> This is the same as running a forEach loop on the Collection
     * {@link com.readonlydev.command.client.ClientBuilder#addSlashCommand(SlashCommand)} multiple times.
     *
     * @param  commands The SlashCommands Collection to add
     *
     * @return          This builder
     */
    ...
    /**
     * Adds a {@link com.readonlydev.command.slash.SlashCommand SlashCommand} and registers it to the {@link com.readonlydev.command.client.Client ClientImpl} for this session.
     *
    ...
    /**
     * Adds and registers multiple {@link com.readonlydev.command.slash.SlashCommand SlashCommand}s to the {@link com.readonlydev.command.client.Client ClientImpl} for this session. <br> This is the same as calling {@link com.readonlydev.command.client.ClientBuilder#addSlashCommand(SlashCommand)}
     * multiple times.
     *
     * @param  commands The Commands to add
     *
     ...
     * {@link com.readonlydev.command.client.Client Client} for this session.
     * <br>This is the same as calling {@link com.readonlydev.command.client.ClientBuilder#addSlashCommand(SlashCommand)} multiple times.
     *
     * @param  contextMenus
    ...
    /**
     * Sets the {@link com.readonlydev.command.CommandListener CommandListener} for the {@link com.readonlydev.command.client.Client ClientImpl}.
     *
    ...
    /**
     * Sets the {@link java.util.concurrent.ScheduledExecutorService ScheduledExecutorService} for the {@link com.readonlydev.command.client.Client ClientImpl}.
     *
    ...
    /**
     * Sets the Command Client to shut down internals automatically when a {@link net.dv8tion.jda.api.events.ShutdownEvent ShutdownEvent} is received.
     *
    ...
    /**
     * Sets the internal size of the client's {@link com.readonlydev.common.utils.FixedSizeCache FixedSizeCache} used for caching and pairing the bot's response {@link net.dv8tion.jda.api.entities.Message Message}s with the calling Message's ID. <p> Higher cache size means that decay of cache
     * contents will most likely occur later, allowing the deletion of responses when the call is deleted to last for a longer duration. However this also means larger memory usage. <p> Setting {@code 0} or negative will cause the client to not use linked caching <b>at all</b>.
     *
     * @param  linkedCacheSize The maximum number of paired responses that can be cached, or {@code <1} if the built {@link com.readonlydev.api.ClientInterface Client} will not use linked caching.
     *
     * @return                 This builder
     */
    ...
    /**
     * Sets the {@link com.readonlydev.settings.GuildSettingsManager GuildSettingsManager} for the ClientImpl built using this builder.
     *
