 ...
 * the call.</li>
 * <li>{@link com.readonlydev.settings.GuildSettingsManager GuildSettingsManager} <br>
 * An abstract object used to store and handle {@code GuildSettingsProvider} implementations.</li>
 * <li>{@link com.readonlydev.settings.GuildSettingsProvider GuildSettingsProvider} <br>
