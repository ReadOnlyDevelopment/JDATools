 ...
 * MessageReceivedEvent}, {@code Client}, and String arguments. The main
 * basis for carrying information to be used in Commands.</li>
 * <li>{@link com.readonlydev.command.CommandListener CommandListener} <br>
 * An interface to be provided to a {@code ClientImpl} that can provide
