...
/**
 * A chain-setter based builder for {@link com.readonlydev.command.Command Commands}.
 * <p>
 ...
 * {@link com.readonlydev.api.ClientInterface#addCommand(Command) Client#addCommand(Command)}.
 * <p>
...
public class CommandBuilder
{
	...
	/**
	 * Sets the {@link com.readonlydev.command.Command#name name} of the Command built from this CommandBuilder.
	 *
	 * @param name
	...
	/**
	 * Sets the {@link com.readonlydev.command.Command#help help} snippet of the Command built from this CommandBuilder.
	 *
	 * @param help
	...
	/**
	 * Sets the {@link com.readonlydev.command.Command#category category} of the Command built from this CommandBuilder.
	 *
	 * @param category
	...
	/**
	 * Adds the {@link com.readonlydev.command.arg.CommandArgument CommandArgument} to the list of
	...
	/**
	 * Adds the specified array of {@link com.readonlydev.command.arg.CommandArgument CommandArgument} to the list of
	 * {@link com.readonlydev.command.Command#arguments arguments} for this command.
	 *
	 * @param arguments
	...
	/**
	 * Sets the {@link com.readonlydev.command.Command#arguments arguments} for this command.
	 *
	 * @param arguments
	...
	/**
	 * Sets the {@link com.readonlydev.command.Command#arguments arguments} of the Command built from this
	 * CommandBuilder.
	 *
	 * @param arguments
	...
	/**
	 * Sets the Command built to be {@link com.readonlydev.command.Command#guildOnly guild only}.
	 *
	 * @param guildOnly
	 ...
	 * {@link com.readonlydev.command.Command#requiredRoles requiredRoles} needed to use this command.
	 *
	 * @param role
	...
	/**
	 * Sets the {@link com.readonlydev.command.Command#requiredRoles requiredRoles} needed to use this command.
	 *
	 * @param roles
	...
	/**
	 * Sets the {@link com.readonlydev.command.Command#requiredRoles requiredRoles} of the Command built from this
	 * CommandBuilder.
	 *
	 * @param roles
	...
	/**
	 * Sets the Command built to be {@link com.readonlydev.command.Command#ownerCommand owner only}.
	 *
	 * @param ownerCommand
	...
	/**
	 * Sets the {@link com.readonlydev.command.Command#cooldown cooldown} of the Command built from this CommandBuilder.
	 *
	 * @param cooldown
	...
	/**
	 * Sets the {@link com.readonlydev.command.Command#userPermissions required user permissions} of the Command built
	...
	/**
	 * Sets the {@link com.readonlydev.command.Command#botPermissions required bot permissions} of the Command built
	 * from this CommandBuilder.
	 *
	...
	/**
	 * Adds a {@link com.readonlydev.command.Command#aliases alias} for the Command built from this CommandBuilder.
	 *
	 * @param alias
	...
	/**
	 * Adds {@link com.readonlydev.command.Command#aliases aliases} for the Command built from this CommandBuilder.
	 *
	 * @param aliases
	...
	/**
	 * Sets the {@link com.readonlydev.command.Command#aliases aliases} of the Command built from this CommandBuilder.
	 *
	 * @param aliases
	...
	/**
	 * Adds a {@link com.readonlydev.command.Command#children child} Command to the Command built from this
	 * CommandBuilder.
	 *
	 * @param child
	...
	/**
	 * Adds {@link com.readonlydev.command.Command#children child} Commands to the Command built from this
	 * CommandBuilder.
	 *
	 * @param children
	...
	/**
	 * Sets the {@link com.readonlydev.command.Command#children children} of the Command built from this CommandBuilder.
	 *
	 * @param children
	...
	/**
	 * Sets the {@link com.readonlydev.command.Command#helpBiConsumer help BiConsumer} of the Command built from this
	 * CommandBuilder.
	 *
	...
	/**
	 * Sets the Command built to {@link com.readonlydev.command.Command#usesTopicTags use TopicTags}.
	 *
	 * @param usesTopicTags
	...
	/**
	 * Sets the {@link com.readonlydev.command.Command#cooldownScope cooldown scope} of the Command built from this
	 * CommandBuilder.
	 *
	 * @param cooldownScope
	...
	/**
	 * Sets the Command built to be {@link com.readonlydev.command.Command#hidden hidden} from the help builder.
	 *
	 * @param hidden
	...
	/**
	 * Builds the {@link com.readonlydev.command.Command Command} using the previously provided information.
	 * <p>
	 * This uses the only the {@link com.readonlydev.command.event.CommandEvent CommandEvent} parameter that would be
	 * provided during {@link com.readonlydev.command.Command#execute(CommandEvent) #execute(CommandEvent)}, and no
	 * information about the Command can be retrieved using this.
	 * <p>
	 * An alternate method {@link com.readonlydev.command.CommandBuilder#build(java.util.function.BiConsumer)} exists if
	 ...
	 * Builds the {@link com.readonlydev.command.Command Command} using the previously provided information.
	 * <p>
	 * This uses the both the {@link com.readonlydev.command.event.CommandEvent CommandEvent} parameter that would be
	 * provided during {@link com.readonlydev.command.Command#execute(CommandEvent) #execute(CommandEvent)}, and the
