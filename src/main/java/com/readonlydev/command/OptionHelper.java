...
public class OptionHelper {
	/**
	 * Gets the provided Option Key as a String value, or returns {@code null} if
	...
	/**
	 * Gets the provided Option Key as a String value, or returns the default one if
	 * the option cannot be found.
	 *
	 * @param event        The slash command event to get options from
	 * @param key          The option we want
	 * @param defaultValue Nullable default value used in the absence of the option
	 *                     value
	...
	/**
	 * Gets the provided Option Key as a boolean value, or returns {@code false} if
	 * the option cannot be found.
	 *
	 * @param event The slash command event to get options from
	 * @param key   The option we want
	...
	/**
	 * Gets the provided Option Key as a boolean value, or returns the default one
	 * if the option cannot be found.
	 *
	 * @param event        The slash command event to get options from
	 * @param key          The option we want
	 * @param defaultValue The fallback option in case of the absence of the option
	 *                     value
	 * @return The provided option, or the default value if the option is not
	 *         present
	 */
	...
	/**
	 * Gets the provided Option Key as a long value, or returns the default one if
	 * the option cannot be found.
	 *
	 * @param event        The slash command event to get options from
	 * @param key          The option we want
	...
	/**
	 * Gets the provided Option Key as a double value, or returns {@code 0.0} if the
	 * option cannot be found.
	 *
	 * @param event The slash command event to get options from
	 * @param key   The option we want
	...
	/**
	 * Gets the provided Option Key as a double value, or returns the default one if
	 * the option cannot be found.
	 *
	 * @param event        The slash command event to get options from
	 * @param key          The option we want
	...
	/**
	 * Gets the provided Option Key as a GuildChannel value, or returns {@code null}
	 * if the option cannot be found. <br>
	 * This will <b>always</b> return null when the SlashCommandInteractionEvent was
	 * not executed in a Guild.
	 *
	 * @param event The slash command event to get options from
	 * @param key   The option we want
	 * @return The provided option, or null if the option is not present
	...
	/**
	 * Gets the provided Option Key as a GuildChannel value, or returns the default
	 * one if the option cannot be found. <br>
	 * This will <b>always</b> return the default value when the
	 * SlashCommandInteractionEvent was not executed in a Guild.
	 *
	 * @param event        The slash command event to get options from
	 * @param key          The option we want
	 * @param defaultValue Nullable default value used in the absence of the option
	...
	/**
	 * Gets the provided Option Key as a Member value, or returns {@code null} if
	 * the option cannot be found. <br>
	 * This will <b>always</b> return null when the SlashCommandInteractionEvent was
	 * not executed in a Guild.
	 *
	 * @param event The slash command event to get options from
	...
	/**
	 * Gets the provided Option Key as a Member value, or returns the default one if
	 * the option cannot be found. <br>
	 * This will <b>always</b> return the default value when the
	 * SlashCommandInteractionEvent was not executed in a Guild.
	 *
	...
	/**
	 * Gets the provided Option Key as a IMentionable value, or returns {@code null}
	 * if the option cannot be found.
	 *
	 * @param event The slash command event to get options from
	 * @param key   The option we want
	...
	/**
	 * Gets the provided Option Key as a IMentionable value, or returns the default
	...
	/**
	 * Gets the provided Option Key as a Role value, or returns {@code null} if the
	 * option cannot be found. <br>
	 * This will <b>always</b> return null when the SlashCommandInteractionEvent was
	 * not executed in a Guild.
	 *
	 * @param event The slash command event to get options from
	...
	/**
	 * Gets the provided Option Key as a Role value, or returns the default one if
	 * the option cannot be found. <br>
	 * This will <b>always</b> return the default value when the
	 * SlashCommandInteractionEvent was not executed in a Guild.
	 *
	...
	/**
	 * Gets the provided Option Key as a User value, or returns {@code null} if the
	 * option cannot be found.
	 *
	 * @param event The slash command event to get options from
	 * @param key   The option we want
	...
	/**
	 * Gets the provided Option Key as a User value, or returns the default one if
	 * the option cannot be found.
	 *
	 * @param event        The slash command event to get options from
	 * @param key          The option we want
