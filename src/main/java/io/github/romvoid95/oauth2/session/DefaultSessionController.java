...
import io.github.romvoid95.oauth2.session.DefaultSessionController.DefaultSession;

/**
 * The default {@link io.github.romvoid95.oauth2.session.SessionController
...
public class DefaultSessionController implements SessionController<DefaultSession> {
	...
	private DefaultSession(String accessToken, String refreshToken, String tokenType, OffsetDateTime expiration,
		Scope[] scopes) {
	...
	private DefaultSession(SessionData data) {
	    this(data.getAccessToken(), data.getRefreshToken(), data.getTokenType(), data.getExpiration(),
		    data.getScopes());
	}
