package io.github.romvoid95.oauth2.entities;
 ...
 * {@link io.github.romvoid95.oauth2.OAuth2Client#getUser(Session)
...
public interface OAuth2User extends ISnowflake, IMentionable {
    /**
     * Gets the underlying {@link io.github.romvoid95.oauth2.OAuth2Client
    ...
    /**
     * Gets the originating {@link io.github.romvoid95.oauth2.session.Session} that
     ...
     * '{@link io.github.romvoid95.oauth2.Scope#EMAIL email}' OAuth
     * {@link io.github.romvoid95.oauth2.Scope Scope}, this will throw a
