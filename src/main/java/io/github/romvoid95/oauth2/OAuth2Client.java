package io.github.romvoid95.oauth2;
...
import io.github.romvoid95.oauth2.entities.OAuth2User;
import io.github.romvoid95.oauth2.entities.impl.OAuth2ClientImpl;
import io.github.romvoid95.oauth2.exceptions.InvalidStateException;
import io.github.romvoid95.oauth2.requests.OAuth2Action;
import io.github.romvoid95.oauth2.session.Session;
import io.github.romvoid95.oauth2.session.SessionController;
import io.github.romvoid95.oauth2.state.StateController;
 ...
 * {@link io.github.romvoid95.oauth2.OAuth2Client.Builder OAuth2Client.Builder},
...
public interface OAuth2Client {
	 ...
	 * fragment and {@link io.github.romvoid95.oauth2.Scope Scopes}.
	 *
	...
	/**
	 * Starts a {@link io.github.romvoid95.oauth2.session.Session Session} with the
	 * provided code, state, and identifier. The state provided should be
	 * <i>unique</i> and provided through an implementation of
	 * {@link io.github.romvoid95.oauth2.state.StateController StateController}.
	 * <p>
	 * If the state has already been consumed by the StateController using
	 * {@link io.github.romvoid95.oauth2.state.StateController#consumeState(String)
	 ...
	 * @param scopes The provided scopes.
	 *
	 * @return A {@link io.github.romvoid95.oauth2.requests.OAuth2Action
	...
	/**
	 * Requests a {@link io.github.romvoid95.oauth2.entities.OAuth2User OAuth2User}
	 * from the {@link io.github.romvoid95.oauth2.session.Session Session}.
	 * <p>
	...
	/**
	 * Requests a list of {@link io.github.romvoid95.oauth2.entities.OAuth2Guild
	 * OAuth2Guilds} from the {@link io.github.romvoid95.oauth2.session.Session
	 * Session}.
	 * <p>
	 * All Sessions should handle an individual Discord User, and as such this
	 * method retrieves data on all the various Discord Guilds that user is a part
	 ...
	 * {@link io.github.romvoid95.oauth2.exceptions.MissingScopeException
	 ...
	 *
	 * @throws io.github.romvoid95.oauth2.exceptions.MissingScopeException If the
	 * provided
	 * Session
	 * does not
	 * have the
	...
	/**
	 * Gets the client's {@link io.github.romvoid95.oauth2.state.StateController
	 * StateController}.
	 *
	...
	/**
	 * Gets the client's {@link io.github.romvoid95.oauth2.session.SessionController
	 * SessionController}.
	 *
	 ...
	 * <p>
	 * At minimum, the developer must provide a valid Client ID, as well as a valid
	 * secret.
	 */
	class Builder {
		...
		/**
		 * Finalizes and builds an {@link io.github.romvoid95.oauth2.OAuth2Client
		 ...
		 * {@link io.github.romvoid95.oauth2.session.SessionController
		 * SessionController}.
		 *
