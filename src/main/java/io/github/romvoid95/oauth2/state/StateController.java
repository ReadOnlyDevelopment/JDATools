package io.github.romvoid95.oauth2.state;
 ...
 *
 * <p>
 * Naturally, states should be unique, and attempting to generate a redirect
 * using a previously used state should return {@code null} instead of a new
 * redirect URI.
 *
 * 
 */
public interface StateController {
     ...
     *
     * <p>
     * Once this method is called for a specific state, it should return null for
     * all future calls of that same state.
     * 
