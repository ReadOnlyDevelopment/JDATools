 ...
 * {@link io.github.romvoid95.command.CommandClient CommandClient} and
 * {@link io.github.romvoid95.command.Command Commands}.
 * <p>
 * All of the contents are used heavily in the
 * {@link io.github.romvoid95.command.CommandClientImpl CommandClientImpl},
 * and are summarized as follows:
 * <ul>
 * <li>{@link io.github.romvoid95.command.CommandBuilder CommandBuilder} <br>
 * An chain builder for Commands.</li>
 * <li>{@link io.github.romvoid95.command.Command Command} <br>
 * An abstract class that can be inherited by classes to create Commands
 * compatible with the {@code CommandClientImpl}.</li>
 * <li>{@link io.github.romvoid95.command.CommandClient CommandClient} <br>
 * An interface used for getting info set when building a
 * {@code CommandClientImpl}.</li>
 * <li>{@link io.github.romvoid95.command.CommandClientBuilder
 ...
 * <li>{@link io.github.romvoid95.command.CommandEvent CommandEvent} <br>
 * A wrapper for a
 ...
 * <li>{@link io.github.romvoid95.command.CommandListener CommandListener} <br>
 ...
 * <li>{@link io.github.romvoid95.command.GuildSettingsManager
 * GuildSettingsManager} <br>
 * An abstract object used to store and handle {@code GuildSettingsProvider}
 * implementations.</li>
 * <li>{@link io.github.romvoid95.command.GuildSettingsProvider
