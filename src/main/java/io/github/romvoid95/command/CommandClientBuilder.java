 ...
 * <p>
 * Once built, add the {@link io.github.romvoid95.command.CommandClient
...
public class CommandClientBuilder {
	...
	/**
	 * Builds a {@link io.github.romvoid95.command.CommandClientImpl
	 * CommandClientImpl} with the provided settings. <br>
	 * Once built, only the {@link io.github.romvoid95.command.CommandListener
	 * CommandListener}, and {@link io.github.romvoid95.command.Command Command}s
	 * can be changed.
	 *
	...
	/**
	 * Sets whether the {@link io.github.romvoid95.command.CommandClient
	 ...
	 * via
	 * {@link io.github.romvoid95.command.CommandClientBuilder#setHelpConsumer(Consumer)}}.
	 *
	 * @return This builder
	 */
	 ...
	 * {@link io.github.romvoid95.command.CommandEvent
	...
	/**
	 * Adds a {@link io.github.romvoid95.command.Command Command} and registers it
	 * to the {@link io.github.romvoid95.command.CommandClientImpl
	...
	/**
	 * Adds and registers multiple {@link io.github.romvoid95.command.Command
	 * Command}s to the {@link io.github.romvoid95.command.CommandClientImpl
	 * CommandClientImpl} for this session. <br>
	 * This is the same as calling
	 * {@link io.github.romvoid95.command.CommandClientBuilder#addCommand(Command)}
	 * multiple times.
	 *
	...
	/**
	 * Adds a {@link io.github.romvoid95.command.SlashCommand SlashCommand} and
	 * registers it to the {@link io.github.romvoid95.command.CommandClientImpl
	 * CommandClientImpl} for this session.
	 *
	...
	/**
	 * Adds and registers multiple {@link io.github.romvoid95.command.SlashCommand
	 * SlashCommand}s to the
	 * {@link io.github.romvoid95.command.CommandClientImpl CommandClientImpl}
	 * for this session. <br>
	 * This is the same as calling
	 * {@link io.github.romvoid95.command.CommandClientBuilder#addSlashCommand(SlashCommand)}
	 * multiple times.
	 *
	 * @param commands The Commands to add
	 *
	...
	/**
	 * Whether or not to set every reply from the bot as an embeded message.
	 * False by default.
	 *
	 * @param embedAllReplies your option.
	 *
	 * @return This Builder
	 */
	 ...
	 * for the {@link io.github.romvoid95.command.CommandClientImpl
	 * CommandClientImpl}.
	 *
	 ...
	 * {@link io.github.romvoid95.utils.FixedSizeCache FixedSizeCache} used for
	 ...
	 * {@link io.github.romvoid95.command.CommandClient
	...
	/**
	 * Sets the {@link io.github.romvoid95.command.GuildSettingsManager
