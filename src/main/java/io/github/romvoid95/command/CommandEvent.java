 ...
 * MessageReceivedEvent}, {@link io.github.romvoid95.command.CommandClient
 * CommandClient}, and String user arguments compatible with all
 * {@link io.github.romvoid95.command.Command Command}s.
 * <p>
 * From here, developers can invoke several useful and specialized methods to
 * assist in Command function and development. There are also "extension"
 * methods for all methods found in MessageReceivedEvent.
 * <p>
 * Methods with "reply" in their name can be used to instantly send a
 * {@link net.dv8tion.jda.api.entities.Message Message} response to the
 * {@link net.dv8tion.jda.api.entities.MessageChannel MessageChannel} the
 * MessageReceivedEvent was in. <br>
 * All {@link net.dv8tion.jda.api.requests.RestAction RestAction} returned by
 * sending a response using these methods automatically
 * {@link net.dv8tion.jda.api.requests.RestAction#queue() RestAction#queue()},
 * and no further developer input is required.
 */
public class CommandEvent {
	 ...
	 * It is a generated wrapper for a
	 * {@link net.dv8tion.jda.api.events.message.MessageReceivedEvent
	 ...
	 * @param client The {@link io.github.romvoid95.command.CommandClient
	 * CommandClient}
	 */
	...
	/**
	 * Returns the prefix used when this event was raised. Useful for figuring out
	 * what people invoked.
	 *
	...
	/**
	 * Returns the {@link io.github.romvoid95.command.CommandClient CommandClient}
	...
	/**
	 * Links a {@link net.dv8tion.jda.api.entities.Message Message} with the calling
	 * Message contained by this CommandEvent.
	 * <p>
	 * This method is exposed for those who wish to use linked deletion but may
	 * require usage of
	 * {@link net.dv8tion.jda.api.entities.MessageChannel#sendMessage(Message)
	 * MessageChannel#sendMessage()} or for other reasons cannot use the standard
	 * {@code reply()} methods.
	 * <p>
	 * If the Message provided is <b>not</b> from the bot (IE:
	 * {@link net.dv8tion.jda.api.entities.SelfUser SelfUser}), an
	 * {@link java.lang.IllegalArgumentException IllegalArgumentException} will be
	 * thrown.
	 *
	 * @param message The Message to add, must be from the SelfUser while linked
	 * deletion is being used.
	 *
	 * @throws java.lang.IllegalArgumentException If the Message provided is not
	 * from the bot.
	 */
	public void linkId(Message message) {
		Checks.check(message.getAuthor().equals(getSelfUser()),
	 ...
	 * <p>
	 * The {@link net.dv8tion.jda.api.requests.RestAction RestAction} returned by
	 * sending the response as a {@link net.dv8tion.jda.api.entities.Message
	 * Message} automatically does
	 * {@link net.dv8tion.jda.api.requests.RestAction#queue() RestAction#queue()}.
	 * <p>
	 * <b>NOTE:</b> This message can exceed the 2000 character cap, and will be sent
	 ...
	 * Message} automatically does
	 * {@link net.dv8tion.jda.api.requests.RestAction#queue() RestAction#queue()}
	 * with the first Consumer as it's success callback and the second Consumer as
	 ...
	 * @param message A String message to reply with
	 * @param success The Consumer to queue after sending the Message is sent.
	 * @param failure The Consumer to run if an error occurs when sending the
	 * Message.
	 */
	...
	/**
	 * Replies with a {@link net.dv8tion.jda.api.entities.MessageEmbed
	 * MessageEmbed}.
	 * <p>
	 * The {@link net.dv8tion.jda.api.requests.RestAction RestAction} returned by
	 * sending the response as a {@link net.dv8tion.jda.api.entities.Message
	 ...
	 * sending the response as a {@link net.dv8tion.jda.api.entities.Message
	 * Message} automatically does
	 * {@link net.dv8tion.jda.api.requests.RestAction#queue() RestAction#success()}
	 * with the provided Consumer as it's success callback.
	 *
	 * @param message The Message to reply with
	 ...
	 * <p>
	 * This method uses
	 * {@link net.dv8tion.jda.api.entities.MessageChannel#sendFile(File, String, net.dv8tion.jda.api.utils.AttachmentOption...)
	 * MessageChannel#sendFile(File, String, AttachmentOption...)} to send the File.
	 * For more information on what a bot may send using this, you may find the info
	 * in that method.
	 *
	...
	/**
	 * Replies with a String message and a {@link java.io.File} with the provided
	 * name, or a default name if left null.
	 * <p>
	 * The {@link net.dv8tion.jda.api.requests.RestAction RestAction} returned by
	 * sending the response as a {@link net.dv8tion.jda.api.entities.Message
	 * Message} automatically does
	...
	/**
	 * Replies with a {@link net.dv8tion.jda.api.entities.MessageEmbed MessageEmbed}
	 * if possible, or just a String message if it cannot send the embed.
	 * <p>
	 * The {@link net.dv8tion.jda.api.requests.RestAction RestAction} returned by
	 * sending the response as a {@link net.dv8tion.jda.api.entities.Message
	 * Message} automatically does
	 * {@link net.dv8tion.jda.api.requests.RestAction#queue() RestAction#queue()}.
	 * <p>
	 * <b>NOTE:</b> This alternate String message can exceed the 2000 character cap,
	 * and will be sent in two split Messages.
	 *
	 * @param embed The MessageEmbed to reply with
	 * @param alternateMessage A String message to reply with if the provided
	 * MessageEmbed cannot be sent
	 */
	 ...
	 * {@link io.github.romvoid95.command.CommandEvent#reply(File,String)
	 * CommandEvent#reply(File, String)} and
	 * {@link io.github.romvoid95.command.CommandEvent#reply(String,File,String)
	 * CommandEvent#reply(String, File, String)}, this method does not throw a
	 * {@link java.io.IOException}. This is because the cause of the alternate
	 * String message being sent comes directly from a thrown
	 * {@link java.lang.Exception}, and thus a thrown IOException is grounds for the
	 * sending of the alternate message.
	 *
	 * @param message A String message to reply with
	 * @param file The File to reply with
	 * @param filename The filename that Discord should display (null for
	 * default).
	 * @param alternateMessage A String message to reply with if the file cannot be
	 * uploaded, or an {@link java.io.IOException} is thrown
	 */
	 ...
	 * <p>
	 * If the User to be Direct Messaged does not already have a PrivateChannel open
	 * to send messages to, this method will automatically open one.
	 * <p>
	 * The {@link net.dv8tion.jda.api.requests.RestAction RestAction} returned by
	 * sending the response as a {@link net.dv8tion.jda.api.entities.Message
	 * Message} automatically does
	...
	/**
	 * Replies with a {@link net.dv8tion.jda.api.entities.MessageEmbed MessageEmbed}
	 * sent to the calling {@link net.dv8tion.jda.api.entities.User User}'s
	 * {@link net.dv8tion.jda.api.entities.PrivateChannel PrivateChannel}.
	 * <p>
	 * If the User to be Direct Messaged does not already have a PrivateChannel open
	 * to send messages to, this method will automatically open one.
	...
	public void replyInDm(MessageEmbed embed, Consumer<Message> success, Consumer<Throwable> failure) {
		if (event.isFromType(ChannelType.PRIVATE)) {
			...
			event.getAuthor().openPrivateChannel().queue(pc -> pc.sendMessageEmbeds(embed).queue(success, failure),
					failure);
		}
	}

	/**
	 * Replies with a {@link net.dv8tion.jda.api.entities.Message Message} sent to
	 * the calling {@link net.dv8tion.jda.api.entities.User User}'s
	 * {@link net.dv8tion.jda.api.entities.PrivateChannel PrivateChannel}.
	 * <p>
	 * If the User to be Direct Messaged does not already have a PrivateChannel open
	 * to send messages to, this method will automatically open one.
	...
	public void replyInDm(Message message, Consumer<Message> success, Consumer<Throwable> failure) {
		if (event.isFromType(ChannelType.PRIVATE)) {
			...
			event.getAuthor().openPrivateChannel().queue(pc -> pc.sendMessage(message).queue(success, failure),
					failure);
		}
	}
	...
	/**
	 * Replies with a String message and a {@link java.io.File} with the provided
	 * name, or a default name if left null, and sent to the calling
	 * {@link net.dv8tion.jda.api.entities.User User}'s
	 * {@link net.dv8tion.jda.api.entities.PrivateChannel PrivateChannel}.
	 * <p>
	 * If the User to be Direct Messaged does not already have a PrivateChannel open
	...
	/**
	 * Uses the
	 * {@link io.github.romvoid95.command.CommandClient#getScheduleExecutor()
	 * client's executor} to run the provided {@link java.lang.Runnable Runnable}
	 * asynchronously without blocking the thread this is called in.
	 * <p>
	...
	/**
	 * Splits a String into one or more Strings who's length does not exceed 2000
	 * characters. <br>
	 * Also nullifies usages of {@code @here} and {@code @everyone} so that they do
	 * not mention anyone. <br>
	 * Useful for splitting long messages so that they can be sent in more than one
	 * {@link net.dv8tion.jda.api.entities.Message Message} at maximum potential
	 * length.
	 *
	 * @param stringtoSend The String to split and send
	 *
	 * @return An {@link java.util.ArrayList ArrayList} containing one or more
	 * Strings, with nullified occurrences of {@code @here} and
	 * {@code @everyone}, and that do not exceed 2000 characters in length
	 */
	...
	/**
	 * Gets a {@link net.dv8tion.jda.api.entities.SelfUser SelfUser} representing
	 * the bot. <br>
	...
	/**
	 * Gets a {@link net.dv8tion.jda.api.entities.Member Member} representing the
	 * bot, or null if the event does not take place on a
	 * {@link net.dv8tion.jda.api.entities.Guild Guild}. <br>
	...
	/**
	 * Tests whether or not the {@link net.dv8tion.jda.api.entities.User User} who
	 * triggered this event is an owner of the bot.
	 *
	...
	/**
	 * Gets the {@link net.dv8tion.jda.api.entities.User User} who triggered this
	 * CommandEvent.
	 *
	...
	/**
	 * Gets the {@link net.dv8tion.jda.api.entities.MessageChannel MessageChannel}
	 ...
	 * {@link net.dv8tion.jda.api.entities.MessageChannel MessageChannel} that the
	 * CommandEvent was triggered on.
	 *
	 * @return The ChannelType of the MessageChannel that this CommandEvent was
	 * triggered on
	 */
	...
	/**
	 * Gets the {@link net.dv8tion.jda.api.entities.Guild Guild} that this
	 * CommandEvent was triggered on.
	 *
	...
	/**
	 * Gets the instance of {@link net.dv8tion.jda.api.JDA JDA} that this
	 * CommandEvent was caught by.
	 *
	...
	/**
	 * Gets the {@link net.dv8tion.jda.api.entities.Member Member} that triggered
	 * this CommandEvent.
	 *
	...
	/**
	 * Gets the {@link net.dv8tion.jda.api.entities.Message Message} responsible for
	 * triggering this CommandEvent.
	 *
	...
	/**
	 * Gets the {@link net.dv8tion.jda.api.entities.PrivateChannel PrivateChannel}
	 * that this CommandEvent may have taken place on, or {@code null} if it didn't
	 * happen on a PrivateChannel.
	 *
	 * @return The PrivateChannel that this CommandEvent may have taken place on, or
	 * null if it did not happen on a PrivateChannel.
	 */
	...
	/**
	 * Gets the {@link net.dv8tion.jda.api.entities.TextChannel TextChannel} that
	 * this CommandEvent may have taken place on, or {@code null} if it didn't
	 * happen on a TextChannel.
	 *
	 * @return The TextChannel this CommandEvent may have taken place on, or null if
	 * it did not happen on a TextChannel.
	 */
	...
	/**
	 * Compares a provided {@link net.dv8tion.jda.api.entities.ChannelType
	 * ChannelType} with the one this CommandEvent occurred on, returning
	 ...
	 * {@link net.dv8tion.jda.api.entities.MessageChannel} of the provided
	 * ChannelType, otherwise {@code false}.
	 */
