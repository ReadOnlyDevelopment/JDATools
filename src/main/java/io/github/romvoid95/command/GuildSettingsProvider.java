 ...
 * <ul>
 * <li>Guild Specific Prefixes (via
 * {@link io.github.romvoid95.command.GuildSettingsProvider#getPrefixes()})</li>
 * </ul>
 ...
 * properly. <br>
 * Additionally, as stated before, the interface itself does not need to be
...
public interface GuildSettingsProvider {
	 ...
	 * <p>
	 * An empty Collection or {@code null} may be returned to signify the Guild
	 * doesn't have any guild specific prefixes, or that this feature is not
