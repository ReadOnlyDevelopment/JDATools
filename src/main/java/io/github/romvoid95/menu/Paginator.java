...
/**
 * A {@link io.github.romvoid95.menu.Menu Menu} implementation that paginates a
...
public class Paginator extends Menu {
	...
	private void initialize(RestAction<Message> action, int pageNum) {
		action.queue(m -> {
			if (pages > 1) {
				...
				m.addReaction(STOP).queue(v -> paginationWithoutTextInput(m, pageNum),
	 ...
	 * {@link io.github.romvoid95.menu.Paginator Paginator}.
	 */
	public static class Builder extends Menu.Builder<Builder, Paginator> {
		...
		/**
		 * Builds the {@link io.github.romvoid95.menu.Paginator Paginator} with this
		 * Builder.
		 *
		 ...
		 * be displayed when the {@link io.github.romvoid95.menu.Paginator Paginator} is
		 * built.
		 * <p>
		 ...
		 * {@link io.github.romvoid95.menu.Paginator Paginator} times out.
		 *
		...
		/**
		 * Sets whether the {@link io.github.romvoid95.menu.Paginator Paginator} will
		...
		/**
		 * Gets the String list of items to paginate. <br>
		...
		/**
		 * Sets the {@link io.github.romvoid95.menu.Paginator Paginator}'s bulk-skip
		...
		/**
		 * Sets the {@link io.github.romvoid95.menu.Paginator Paginator} to wrap from
		...
		/**
		 * Sets the {@link io.github.romvoid95.menu.Paginator Paginator} to allow a page
		...
		/**
		 * Sets the {@link io.github.romvoid95.menu.Paginator Paginator} to traverse
