 ...
 * the Slideshow prematurely using the stop reaction.
 */
public class Slideshow extends Menu {
	...
	Slideshow(EventWaiter waiter, Set<User> users, Set<Role> roles, long timeout, TimeUnit unit,
			...
			BiFunction<Integer, Integer, String> description, Consumer<Message> finalAction, boolean showPageNumbers,
	 ...
	 * {@link io.github.romvoid95.menu.Slideshow Slideshow}.
	 */
	public static class Builder extends Menu.Builder<Builder, Slideshow> {
		...
		/**
		 * Builds the {@link io.github.romvoid95.menu.Slideshow Slideshow} with this
		 * Builder.
		 *
		...
		public Slideshow build() {
			...
			return new Slideshow(waiter, users, roles, timeout, unit, color, text, description, finalAction,
					showPageNumbers, strings, waitOnSinglePage, bulkSkipNumber, wrapPageEnds, textToLeft, textToRight,
					allowTextInput);
		}
		 ...
		 * be displayed when the {@link io.github.romvoid95.menu.Slideshow Slideshow} is
		 * built.
		 * <p>
		...
		/**
		 * Sets the description of the {@link net.dv8tion.jda.api.entities.MessageEmbed
		 * MessageEmbed} in the {@link net.dv8tion.jda.api.entities.Message Message} to
		 * be displayed when the {@link io.github.romvoid95.menu.Slideshow Slideshow} is
		 * built.
		 *
		 ...
		 * <br>
		 * As the page changes, the BiFunction will re-process the current page number
		 * and the total page number, allowing for the displayed description of the
		 ...
		 * {@link io.github.romvoid95.menu.Slideshow Slideshow} times out.
		 *
		...
		/**
		 * Sets whether the {@link io.github.romvoid95.menu.Slideshow Slideshow} will
		 * instantly timeout, and possibly run a provided {@link java.lang.Runnable
		...
		/**
		 * Sets the {@link io.github.romvoid95.menu.Slideshow Slideshow}'s bulk-skip
		...
		/**
		 * Sets the {@link io.github.romvoid95.menu.Slideshow Slideshow} to wrap from
		...
		/**
		 * Sets the {@link io.github.romvoid95.menu.Slideshow Slideshow} to allow a
		...
		/**
		 * Sets the {@link io.github.romvoid95.menu.Slideshow Slideshow} to traverse
