...
/**
 * A {@link io.github.romvoid95.menu.Menu Menu} implementation, nearly identical
 * to {@link io.github.romvoid95.menu.Paginator Paginator}, that displays an
 ...
 * the EmbedPaginator prematurely using the stop reaction.
 */
public class EmbedPaginator extends Menu {
	...
	protected EmbedPaginator(EventWaiter waiter, Set<User> users, Set<Role> roles, long timeout, TimeUnit unit,
			BiFunction<Integer, Integer, String> text, Consumer<Message> finalAction, boolean waitOnSinglePage,
			List<MessageEmbed> embeds, int bulkSkipNumber, boolean wrapPageEnds, String leftText, String rightText,
	 ...
	 * {@link io.github.romvoid95.menu.EmbedPaginator EmbedPaginator}.
	 */
	public static class Builder extends Menu.Builder<Builder, EmbedPaginator> {
		...
		/**
		 * Builds the {@link io.github.romvoid95.menu.EmbedPaginator EmbedPaginator}
		 * with this Builder.
		 *
		...
		public EmbedPaginator build() {
			...
			return new EmbedPaginator(waiter, users, roles, timeout, unit, text, finalAction, waitOnSinglePage, embeds,
					bulkSkipNumber, wrapPageEnds, leftText, rightText, allowTextInput);
		}

		/**
		 * Sets the text of the {@link net.dv8tion.jda.api.entities.Message Message} to
		 * be displayed when the {@link io.github.romvoid95.menu.EmbedPaginator
		 ...
		 * {@link io.github.romvoid95.menu.EmbedPaginator EmbedPaginator} times out.
		 *
		...
		/**
		 * Sets whether the {@link io.github.romvoid95.menu.EmbedPaginator
		...
		/**
		 * Adds {@link net.dv8tion.jda.api.entities.MessageEmbed MessageEmbeds} to the
		...
		/**
		 * Adds {@link net.dv8tion.jda.api.entities.MessageEmbed MessageEmbeds} to the
		 * list of items to paginate. <br>
		 * This method creates a new, basic MessageEmbed containing only the provided
		 * String as description. <br>
		 * Use the {@link io.github.romvoid95.menu.Paginator Paginator} for more Embed
		...
		public Builder addItems(String... items) {
			for (String item : items) {
				Checks.check(item.length() <= MessageEmbed.TEXT_MAX_LENGTH,
		...
		/**
		 * Sets the {@link net.dv8tion.jda.api.entities.MessageEmbed MessageEmbeds} to
		 * paginate. <br>
		 ...
		 * Sets the {@link net.dv8tion.jda.api.entities.MessageEmbed MessageEmbeds} to
		 * paginate. <br>
		 * This method clears all previously set items before adding the provided
		 ...
		 * Sets the {@link net.dv8tion.jda.api.entities.MessageEmbed MessageEmbeds} to
		 * paginate. <br>
		 * This method clears all previously set items before setting each String as a
		 * new MessageEmbed. <br>
		 * Use the {@link io.github.romvoid95.menu.Paginator Paginator} for more Embed
		 * customization, without providing your own MessageEmbed instances.
		 *
		...
		/**
		 * Sets the {@link io.github.romvoid95.menu.EmbedPaginator EmbedPaginator}'s
		...
		/**
		 * Sets the {@link io.github.romvoid95.menu.EmbedPaginator EmbedPaginator} to
