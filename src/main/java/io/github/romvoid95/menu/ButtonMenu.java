...
public class ButtonMenu extends Menu {
	...
	ButtonMenu(EventWaiter waiter, Set<User> users, Set<Role> roles, long timeout, TimeUnit unit, Color color,
			String text, String description, List<String> choices, Consumer<ReactionEmote> action,
	 ...
	 * {@link io.github.romvoid95.menu.ButtonMenu ButtonMenu}.
	 */
	public static class Builder extends Menu.Builder<Builder, ButtonMenu> {
		...
		/**
		 * Builds the {@link io.github.romvoid95.menu.ButtonMenu ButtonMenu} with this
		 * Builder.
		 *
		 ...
		 * be displayed when the {@link io.github.romvoid95.menu.ButtonMenu ButtonMenu}
		 * is built.
		 * <p>
		 ...
		 * {@link io.github.romvoid95.menu.ButtonMenu ButtonMenu} is done, either via
		 * cancellation, a timeout, or a selection being made.
		 * <p>
		...
		/**
		 * Adds a single custom {@link net.dv8tion.jda.api.entities.Emote Emote} as
		 * button choices.
		 * <p>
